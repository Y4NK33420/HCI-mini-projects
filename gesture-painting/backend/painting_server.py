...
class GesturePainter:
    ...
    def __init__(self):
        ...
        self.shape_cycle_interval = (
            4.0  # Cycle through shapes every 4 seconds (slower, more predictable)
        )
            ...
            if self.selected_shape:
                ...
                if self.shape_cycle_start > 0:
                    ...
                    if elapsed < self.shape_cycle_initial_delay:
                        ...
                        next_shape_index = (self.current_shape_index + 1) % len(
                            self.shapes
                        )
                    ...
                    cv2.rectangle(
                        frame,
                        (bar_x, bar_y),
                        (bar_x + int(bar_w * cycle_progress), bar_y + bar_h),
                        bar_color,
                        -1,
                    )
                    # Border
                    ...
                    text_size = cv2.getTextSize(
                        status_text, cv2.FONT_HERSHEY_SIMPLEX, 0.4, 1
                    )[0]
